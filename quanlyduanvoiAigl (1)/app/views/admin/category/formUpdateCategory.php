  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <h4 class="text-center mt-4 ">FORM SỬA DANH MỤC SẢN PHẨM</h4>
                <form action="./?act=admin/update_Category" method="POST">
                <table class="table">
                    <input type="hidden" name="id_danhMuc" value="<?php echo $categorys['id_danhMuc']  ?>">
                    <tr>
                        <td><label for="nameCategory">Tên danh mục</label></td>
                        <td><input type="text" id="nameCategory" value="<?php echo $categorys['ten_danhMuc']?>" class="form-control" name="nameCategory"></td>
                    </tr>
                    <tr>
                        <td colspan="2">
