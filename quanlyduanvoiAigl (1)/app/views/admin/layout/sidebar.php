      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/listProducts" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách sản phẩm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?act=admin/detailProducts" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Chi tiết sản phẩm</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?act=admin/formAddProduct" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/categorys" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/listcustomers" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/comments" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh sách bình luận</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?act=admin/detailcomments" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/orderAdmin" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Đơn hàng</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./?act=admin/ram" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ram</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?act=admin/capacity" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dung lượng</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./?act=admin/color" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Màu sắc</p>
                </a>
              </li>
