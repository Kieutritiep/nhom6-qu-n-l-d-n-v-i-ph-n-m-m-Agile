                ...
                <div class="container">
                    <div class="card card-warning">
                        <div class="card-header">
                            <h3 class="card-title">Form Sửa Màu Sắc</h3>
                        </div>
                        <!-- Form Start -->
                        <form action="" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ten_mauSac" name="ten_mauSac" value="<?= htmlspecialchars($color['ten_mauSac']); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="maMau">Mã Màu</label>
                                    <input type="text" class="form-control" id="maMau" name="maMau" value="<?= htmlspecialchars($color['maMau']); ?>" required>
                                </div>
                            </div>
                            <!-- Card Footer -->
